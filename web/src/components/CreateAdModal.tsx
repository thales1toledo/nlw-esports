                    ...
                    <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <select
                                ...
                                defaultValue=""
                            >
                                <option defaultValue="" disabled selected value="">Selecione o game que deseja jogar</option>
                                {games.map(game => {
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                ...
                                <Input
                                    name='yearsPlaying' id="yearsPlaying" type="text" placeholder="Tudo bem ser ZERO" />
                            </div>

                            <div className="flex flex-col gap-2">
                                <label htmlFor="discord">Qual o seu discord?</label>
                                <Input
                                    name="discord" id="discord" type="text" placeholder="Usuario#0000" />
                            </div>
                        </div>
                        ...
                        <div className="flex gap-6">
                            ...
                            <div className="flex flex-col gap-2 flex-1">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <Input type="time"
                                        name="hourStart" id="hourStart" placeholder='De' />
                                    <Input type="time"
                                        name="hourEnd" id="hourEnd" placeholder='Até' />
                                </div>
                            </div>
                        </div>
